...
if("TRUE" STREQUAL "TRUE")
  set(custom_msgs_SOURCE_PREFIX /home/kpach/catkin_ws/src/compgx01_lab/custom_msgs)
  set(custom_msgs_DEVEL_PREFIX /home/kpach/catkin_ws/src/compgx01_lab/custom_msgs/cmake-build-debug/devel)
...
if(NOT "/home/kpach/catkin_ws/src/compgx01_lab/custom_msgs/cmake-build-debug/devel/include " STREQUAL " ")
  set(custom_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/kpach/catkin_ws/src/compgx01_lab/custom_msgs/cmake-build-debug/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'custom_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kpach <kpach@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'custom_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kpach/catkin_ws/src/compgx01_lab/custom_msgs/${idir}'.  Ask the maintainer 'kpach <kpach@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kpach/catkin_ws/src/compgx01_lab/custom_msgs/cmake-build-debug/devel/lib;/home/kpach/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
